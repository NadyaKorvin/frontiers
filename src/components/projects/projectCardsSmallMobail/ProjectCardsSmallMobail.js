      ...
      <div className="small_mobail__project_cards__block">
        {DataProjects.map((elem) =>
          handleValue <= elem.min ? (
            ...
            //1. Див для поиска нужной карточки. При клике на карточку ее ключ пректа записывается в стейт
            <div className="small_mobail_project__card" key={elem.key + "small_mobail_project__card"}>
              ...
              >
                ...
                <div className="small_mobail_project_card_grey__visible" onClick={() => setOpenFullProjectDescription(!openFullProjectDescription)}>
