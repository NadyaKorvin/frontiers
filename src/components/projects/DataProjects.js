export const DataProjects = [
...

  {
    ...
    income_ultra: 30,
    description:
      "Компания занимается производством и переработкой сельскохозяйственной продукции собственного производств, а также ее транспортировкой, хранением и реализацией.",
    inshure: [
      {
...

  {
    ...
    income_ultra: 25,
    description:
      "Компания одна из первых петербургских компаний, вышедших на профессиональный рынок индивидуальных складских услуг для жителейнашего города.",
    inshure: [
      {
