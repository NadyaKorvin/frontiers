      ...
      <section className="firstscreen">
        ...
        <div className="firstscreen__content">
          ...
          <div className="firstscreen__content_rihgt_text">
            <div className="firstscreen__content_rihgt_text_up">
              <p>
                Мы помогли заработать более 50 млн рублей частным инвесторам в
                2021 году на вложениях в российский бизнес
              </p>
            </div>
            <div className="firstscreen__content_rihgt_text_down">
              <p>НЕ</p>
        ...
        <div className="firstscreen__content_bottom_content">
          <div className="firstscreen__content_bottom_content_left">
            <div className="firstscreen__content_bottom_content_left_scrolldown">
              <p>ПРОКРУТИ ВНИЗ</p>
            </div>
            <div className="firstscreen__content_pointer">{pointer}</div>
          </div>
          <div className="firstscreen__content_bottom_content_right">
            <img src={image} alt="" className="firstscreen__img" />
          </div>
        </div>
      </section>
    </>
