    ...
    <>
      <section className="first__screen">
        <header className="first__header">
          <div className="first__logotype">FRONTIERS</div>
          <nav className="first__nav__sidebar">
            <ul>Агенство</ul>
            <ul>Кейсы</ul>
            <ul>Услуги</ul>
            <ul>Контакты</ul>
          ...
          <div className="first__button">
            <p className="first__text__btn">Получить консультацию</p>
          </div>
        </header>
        <div className="first__content">
          ...
          <p>ПРОКРУТИ ВНИЗ</p>
          <div className="first__content__pointer">{pointer}</div>
          <img src={image} alt="" />
        </div>
      </section>
    </>
